export default defineEventHandler((event) => {
  return [
    ...
    },
    {
      ...
      csb: "He took his wife, Sarai, his nephew Lot, all the possessions they had accumulated, and the people they had acquired in Haran, and they set out for the land of Canaan. When they came to the land of Canaan,",
    ...
    {
      number: 6,
      nkjv: "Abram passed through the land to the place of Shechem, as far as the terebinth tree of Moreh. And the Canaanites <i>were</i> then in the land.",
